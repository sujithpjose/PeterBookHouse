        ...
        return {
            ...
            link: function ($scope, element, attrs) {
                ...
                if (attrs.title || attrs.tooltip) {
                    ...
                    element.on('touchstart', $scope.createTooltip);
                    element.on('touchend', $scope.removeTooltip);
                } else {
                    // remove events
                    element.off('touchstart', $scope.createTooltip);
                    element.off('touchend', $scope.removeTooltip);
                }
